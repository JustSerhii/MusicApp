...
export const musicNote = <i className="fa-solid fa-music"></i>;

export const headphones = <i className="fa-solid fa-headphones"></i>;
export const guitar = <i className="fa-solid fa-guitar"></i>;

export const grid = <i className="fa-solid fa-th"></i>;
export const simplelist = <i className="fa-solid fa-list"></i>;

export const mysongs = <i className="fa-solid fa-microphone"></i>

export const learn = <i className="fa-solid fa-graduation-cap"></i>;
